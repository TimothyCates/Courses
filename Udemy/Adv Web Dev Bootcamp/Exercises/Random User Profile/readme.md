...
In this exercise we are tasked with using the fetch api to gather data from an api that generates random user data, and use said data to update the UI of an already made webpage.
...
<div class="user-profile">
 <img id="avatar" src="https://randomuser.me/api/portraits/men/22.jpg" />
